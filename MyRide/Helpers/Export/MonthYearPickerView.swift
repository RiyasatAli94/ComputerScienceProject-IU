...
class MonthYearPickerView: UIPickerView, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    func commonSetup() {
        ...
        var years: [Int] = []
        if years.count == 0 {
            var startYear = (NSCalendar(identifier: NSCalendar.Identifier.gregorian)!.component(.yearForWeekOfYear, from: NSDate() as Date) - 5)
        ...
        let c = self.years.count - 1
        self.selectRow(c , inComponent: 1, animated: false)
    }
